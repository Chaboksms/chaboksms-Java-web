# Chaboksms Java for Web (Play Framework)
...
برای استفاده از وب سرویس چابک اس ام اس، می توانید یک کنترلر آسنکرون ایجاد کنید و مطابق زیر از دستورات استفاده کنید
